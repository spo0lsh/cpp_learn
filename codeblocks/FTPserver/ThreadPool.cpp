...
int CThreadPool::initThreadPool(int maxPoolSize, std::string dbFile)
{
    ...
    std::cout << "CThreadPool::initThreadPool m_pDatabaseOperations->createDatabaseStructure status: " << m_pDatabaseOperations->createDatabaseStructure(dbFile) << std::endl;
